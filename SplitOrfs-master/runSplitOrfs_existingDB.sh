...
if [[ ($# -ne 3 && $# -ne 4) ]]; then
	...
	blastp -query ${output}/OrfProteins.fa -db G:/Justin_Backup_29.04.2020/Justin/Uni-Frankfurt/FP+Masterarbeit/Results/ProteinDatabase -out ${output}/OrfsAlign.txt -outfmt "6 std" -evalue 10 -num_threads 2
